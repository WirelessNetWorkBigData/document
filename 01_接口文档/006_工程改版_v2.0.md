...
**请求方式**:   POST  
**请求地址**：/preciseplan/engineeringManagement/getTaskCountList
...
| cover_rate     | String   | 是       | 覆盖率（已经想x100）     |
| sinr_cov       | String   | 是       | sinr覆盖率（已经想x100） |
...
**请求方式**:   POST  
**请求地址**：/preciseplan/engineeringManagement/getPlanMsg
...
**请求方式**:   POST  
**请求地址**：/preciseplan/engineeringManagement/getTestMsg
...
**请求方式**:   POST  
**请求地址**：/preciseplan/engineeringManagement/downloadSpeedOfProgressProjectQualifiedCount
